// src/lib.rs
/*
 * Core library for CheckerDynamic
 */
...
#[derive(Debug)]
pub struct CheckerDynamicProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CheckerDynamicProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CheckerDynamic processing");
    
    let mut processor = CheckerDynamicProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CheckerDynamicProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CheckerDynamicProcessor::new(false);
